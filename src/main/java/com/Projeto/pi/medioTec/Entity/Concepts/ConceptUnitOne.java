...
@Entity
@Table(name =  "tb_concpts_unit_one")
public class ConceptUnitOne {
    ...
    public ConceptUnitOne() {
    }

    public ConceptUnitOne(String id, Users aluno, Disciplines discipline, Concepts AV1, Concepts AV2, FinalStatus status) {
        this.id = id;
        this.aluno = aluno;
